...
int main(int argc, char** argv) {
    ...
    srand(static_cast<unsigned int>(time(0))); //declare time 0
    Link *lnkList;
    int numList=8,valAdd=42;
...
//creates priority to highest values
...
Link *fillLst(int n){
    ...
    do{
       ...
       temp->data=rand()%(90)+10;        //Fill with data
