...
Link <int> * addStrt(Link <int> *, int);    //Adds a link to the beginning
Link <int> * addAftr(Link <int> *, int, int);    //adds value int after int
Link <int> * addBefr(Link <int> *, int, int);   //adds value int before int
Link <int> * fndBefr(Link <int> *, int);          //find link pointer before given value
Link <int> * delVal(Link <int> *, int);     //deletes link at that hold given value;
...
int main(int argc, char** argv) {
    ...
    cout<<"This method uses a template "<<endl;
    Link <int> *lnkList;
...
Link <int> *delVal(Link <int> *front,  int value)
{
    Link <int> *temp1 = new Link <int>; //create new link
    Link <int> *temp2 = new Link <int>; //create new link
...
Link <int> *addStrt(Link <int> *front, int data)
{
...
int   findLst(Link <int> *front,int value){
    ...
    Link <int> *temp=front;       //Prepare to traverse the Linked list
    do{
...
//find value before
Link <int> *fndBefr(Link <int> *front, int value)
{
    Link <int> *temp = front;
    do
    {
...
//345678901234567890123456789012345678901234567890123456789012345678901234567890
//adds after a value
Link <int> *addAftr(Link <int> *front, int val, int addVal)
{
    Link <int> *add = new Link <int>; //create link to add
    add->data=addVal;       //set addVal
    Link <int> *temp = new Link <int>; //create new temp
...
//
//adds before a value
Link <int> * addBefr(Link <int> *front, int val, int addVal)
{
    Link <int> *add = new Link <int>; //create new link add
    add->data = addVal;     //set its data = to addVal
    Link <int> *temp = new Link <int>;  //create new link 
    Link <int> *temp2 = new Link <int>; //create second new link for copying
